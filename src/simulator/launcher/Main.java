...
public class Main {
	...
	private static void initFactories() {
		// Create and initialize the body factory
        ...
        // Create and initialize the force laws factory
	...
	private static void startBatchMode() throws Exception {
		...
		//System.out.println(_forceLawsInfo.toString());
		// create the simulator with the specified force laws and delta-time
		PhysicsSimulator simulator = new PhysicsSimulator(
				_forceLawsFactory.createInstance(_forceLawsInfo), _dtime);
		...
		// create the controller with the simulator and the bodies factory
		Controller controller = new Controller(simulator, _forceLawsFactory, _bodyFactory);

		// load the data into the simulator
